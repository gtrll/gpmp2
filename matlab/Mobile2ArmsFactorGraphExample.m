% example of planar mobile base with 2 arms 
...
title('Layout')
plotPlanarMobile2Arms(marm.fk_model, pstart, [0.8 0.4], 'b', 1);
plotPlanarMobile2Arms(marm.fk_model, pend, [0.8 0.4], 'r', 1);
hold off
...
for i = 0 : total_time_step
    ...
    % cost factor
    graph.add(ObstaclePlanarSDFFactorPose2Mobile2Arms(key_pos, ...
    ...
    if i > 0
        ...
        if use_GP_inter & check_inter > 0
            for j = 1:check_inter
                ...
                graph.add(ObstaclePlanarSDFFactorGPPose2Mobile2Arms( ...
...
%     plotPlanarMobile2Arms(marm.fk_model(), p, [0.8 0.4], 'b', 1);
